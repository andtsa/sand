...
//! visible outside those scopes, and that shadowed variables don't mutate outer bindings.

use crate::common::*;
use sand::interpreter::mir::MirValue;

/// Variable declared inside `then` branch is not visible after the if expression.
#[test]
