...
use sand::ir_types::typed_hir::{Expression, TypedProgram};
...
/// Parse source code into an HHIR ProgramModule (no qualification or type checking)
...
/// Run source code through full HIR compilation and interpret in HIR interpreter
...
/// Run source code through full HIR compilation and expect HIR interpretation to fail
...
/// Run source code through full HIR compilation, lower to MIR, and interpret in MIR interpreter
...
/// Run source code through full HIR compilation, lower to MIR, and interpret in MIR interpreter,
/// returning the Result to allow testing for expected failures
